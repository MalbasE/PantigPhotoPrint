...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['layout'], $_POST['paper-type'], $_POST['copies'], $_POST['printType'], $_POST['price'])) {
    ...
    if ($stmt->execute()) {
        header("Location: user_docu.php?message=added");
        exit();
    } else {
...
<body>
    ...
    <!-- Flyers Section -->
    <form action="user_docu.php" method="POST" enctype="multipart/form-data">
    ...
    ?>
   <div class="col">
     <img src="../images/docu.png" alt="docpic" class="docpic">
        <div class="id_type">
            <div class="label">
            ...
            <div class="label">
                <label for="paper-type">Document Type:</label>
