...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['layout'], $_POST['paper-type'], $_POST['copies'], $_POST['printType'], $_POST['price'])) {
    ...
    if ($stmt->execute()) {
        header("Location: user_invitations.php?message=added");
        exit();
    } else {
...
<body>
    ...
    <!-- Flyers Section -->
    <form action="user_invitations.php" method="POST" enctype="multipart/form-data">
    ...
    ?>
   <div class="col">
   <img src="../images/INVI.png" alt="idpic" class="idpic">
        <div class="id_type">
            <div class="label">
                <label for="layout">Layout Size:</label>
                <select class="option" name="layout" id="layout" required>
                    <option selected value="A6">A6 (105mm x 148mm / 4.1in x 5.8in)</option>
                    <option value="A7">A7 (74mm x 105mm / 2.9in x 4.1in)</option>
                    <option value="Square">Square (140mm x 140mm / 5.5in x 5.5in)</option>
                    <option value="4x6">4x6 (101mm x 152mm / 4in x 6in)</option>
                    <option value="5x7">5x7 (127mm x 178mm / 5in x 7in)</option>
                    <option value="DL">DL (99mm x 210mm / 3.9in x 8.3in)</option>
                    <option value="Half Letter">Half Letter (140mm x 216mm / 5.5in x 8.5in)</option>
            ...
            <div class="label">
                ...
                <select class="option" name="paper-type" id="paper-type" required >
                    <option selected value="Matte">Matte Paper</option>
...
function calculatePrice() {
    ...
    const layoutPrices = {
                ...
                'DL': 5, // ₱5.00
                'Half Letter': 8, // ₱8.00
                'Custom': 10 // ₱10.00 (Custom sizes are more expensive)        
    };
