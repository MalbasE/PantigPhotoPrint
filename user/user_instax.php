...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['layout'], $_POST['paper-type'], $_POST['copies'], $_POST['printType'], $_POST['price'])) {
    ...
    if ($stmt->execute()) {
        header("Location: user_instax.php?message=added");
        exit();
    } else {
...
<body>
    ...
    <div class="header">
        ...
        <div class="mid-sec">
            ...
            <div class="navbar">
                <div class="dropdown">
                <input type="hidden" name="service_type" id="service">
    ...
    <!-- Flyers Section -->
    <form action="user_instax.php" method="POST" enctype="multipart/form-data">
        <h2>Instax</h2>
    ...
    ?>
   <div class="col">
   <img src="../images/image4.png" alt="Instax" class="Instax">
        <div class="id_type">
            <div class="label">
                <label for="layout">Instax film sizes </label>
                <select class="option" name="layout" id="layout" required>
                <option selected value="Instax Mini">Instax Mini (54mm x 86mm)</option>
                <option value="Instax Square">Instax Square (72mm x 85.6mm)</option>
                <option value="Instax Wide">Instax Wide (108mm x 86mm)</option>
                </select>
            </div>
            <div class="label">
